...
knowledge0 = And(
    # TODO
    Or(AKnight,AKnave),     #Should be XOr but not included
...
knowledge3 = And(
    ...
    Implication(AKnight,And(AKnight,AKnave)), #if I don't know which, then he tells the truth and then I would know he is a knight
